<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">City Restaurant</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/City Restaurant" class="hvr-grow">Home</a></li>
		        <li><a href="/City Restaurant/about-City-Restaurant.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/City Restaurant">Home</a></li>
	        <li><a href="/City Restaurant/about-City-Restaurant.php">About Us</a></li>
